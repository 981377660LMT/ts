 ...
 * @returns
 */
export default function Autowired(dependencyid?: string, singleton?: boolean): PropertyDecorator {
  return (targetClassPrototype, propertyKey) => {
    ...
    Reflect.defineProperty(targetClassPrototype, propertyKey, { value: ServiceImplInstance }) // 修改为 PropServiceImplClassObj
  }
}
