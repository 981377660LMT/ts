export type RemoveTail<S extends string, Tail extends string> = S extends `${infer P}${Tail}`
  ? P
  : S
...
// 2 嵌套
type removeTailFirstType2 = RemoveTail<
  '/showFood.beijing-china/:foodname/:price',
  '/:foodname/:price'
>
